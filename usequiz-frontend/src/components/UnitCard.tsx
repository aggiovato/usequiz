...
const UnitCard = ({ subject, unit, svg }: UnitCardProps) => {
  return (
    <Link
      to={`/subjects/${subject}/${unit}/questions`}
    ...
    >
      <div className="absolute -top-5 -right-5 w-[150px] h-[150px] rotate-45 -z-10 pointer-events-none select-none bg-teal-shine2/15 transition-all duration-300 group-hover:-top-10 group-hover:rotate-60 group-hover:w-[200px] group-hover:h-[200px]" />
      ...
      <h3 className="text-lg font-medium">{unit}</h3>
    </Link>
  );
};
